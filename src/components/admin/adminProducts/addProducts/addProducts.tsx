...
import { getProducts } from "../../adminSlice/adminSlice";
//Firebase
...
import {
  THookArgs,
  useAddValidation,
} from "../../../../hooks/useAddValidation";
import { useAppDispatch, useAppSelector } from "../../../../app/store";

const initialState: Omit<TProduct, "id"> = {
  name: "",
  brand: "",
  gender: "",
  category: "",
...
function AddProducts() {
  ...
  const allProduct = useAppSelector((state) => state.admin.allProducts);
